...
namespace app\manager\dingTalk;

use app\exception\CustomException;
use app\manager\dingTalk\enums\UserActiveEnum;
use app\manager\dingTalk\enums\UserAdminEnum;
use app\manager\dingTalk\enums\UserBossEnum;
use app\manager\dingTalk\enums\UserSeniorEnum;
use app\manager\dingTalk\model\User;
