...
class TenantEntity
{
    ...
    #[OA\Property(property: 'description', description: '租户描述', type: 'string')]
    private string $description;

    #[OA\Property(property: 'is_internal', description: '是否是内部租户: 1=是 2=否', type: 'integer')]
