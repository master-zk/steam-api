...
#[OA\Schema(schema: 'CdrTableAEntity')]
class CdrTableAEntity
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'depart_guid', description: '', type: 'string')]
    private string $depart_guid;
    ...
    public function getDepartGuid(): string
    {
        return $this->depart_guid;
    }

    public function setDepartGuid(string $depart_guid): void
    {
