...
class RoleRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByInput(RoleEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneByIdReturnRoleOutput(int $id): ?RoleEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneByWhereReturnRoleOutput(array $condition): ?RoleEntity
    {
     ...
     * @throws Exception
     */
    public function findAllReturnRoleOutput(array $condition = []): array
    {
     ...
     * @throws Exception
     */
    public function paginateReturnRoleOutput(array $condition, int $page, int $pageSize): array
    {
