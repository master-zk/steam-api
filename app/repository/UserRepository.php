...
class UserRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByInput(UserEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneByIdReturnUserOutput(int $id): ?UserEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneByWhereReturnUserOutput(array $condition): ?UserEntity
    {
