...
class PermissionRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function createByInput(PermissionEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneByIdReturnPermissionOutput(int $id): ?PermissionEntity
    {
     ...
     * 按照条件查询
     */
    public function findOneByWhereReturnPermissionOutput(array $condition): ?PermissionEntity
    {
     ...
     * @throws Exception
     */
    public function findAllReturnPermissionOutput(array $condition = []): array
    {
     ...
     * @throws Exception
     */
    public function paginateReturnPermissionOutput(array $condition, int $page, int $pageSize): array
    {
